...
uv run --with git+https://github.com/Lifemap-ToL/pylifemap.git --with jupyter jupyter-lab

# Run a marimo session
uv run --with git+https://github.com/Lifemap-ToL/pylifemap.git --with marimo marimo edit
