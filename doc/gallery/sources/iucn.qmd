...
# Plot
Lifemap(agg, center=41666, zoom=13).layer_donuts(counts_col="redlistCategory", scheme="Turbo", radius = [70, 150], show_totals = True, lazy_zoom=4, declutter=False, opacity=0.7, categories=order_cat).show()
