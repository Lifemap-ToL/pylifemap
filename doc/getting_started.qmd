...
You can get the full list of unknown or duplicated taxids by using the helper functions [get_unknown_taxids](`~pylifemap.get_unknown_taxids`) and [get_duplicated_taxids](`~pylifemap.get_duplicated_taxids`).
:::
